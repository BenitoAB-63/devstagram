...
@push('styles')
    {{-- Añadimos los estilos de dropzone --}}
...
@section('contenido')
    <div class="md:flex md:items-center ">
        ...
        <div class="md:w-1/2 px-10">
            <form action="{{route('imagenes.store')}}" method="POST" enctype="multipart/form-data" id="dropzone" class="dropzone border-dashed border-2 w-full h-95 rounded flex flex-col justify-center items-center">
            @csrf
            </form>
        </div>

        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl shadow-gray-700">
            ...
            <form action="{{route('posts.store')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="titulo" name="titulo" placeholder="Título de la publicación" value="{{old('titulo')}}" class="border p-3 w-full rounded-lg @error('titulo') border-red-500 @enderror" >
                    @error('titulo')
